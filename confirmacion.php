...
<html lang="en">
        ...
        <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="glyphicon glyphicon-print"></span> Carros sin Pedidos </h2>
                </div>                   
								...
								<table id="tablaDem" class="table tablaProductos" >
									<thead>
										<tr>
											...
											<th><center>Cod Autorizacion</center></th>
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="js/sistema/confirmacion.js"></script>              
        <!-- END PLUGINS -->
