...
<html lang="en">
        ...
        <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="glyphicon glyphicon-print"></span> ENTRADA MERCADERIA</h2>
                </div>                   
                ...
                <div class="page-content-wrap">   
					<div class="col-md-12">
						<div class="col-lg-6" style ='margin-bottom:2%;'>
								<input class ='col-lg-4' id="txt_Dem"type="text" placeholder="Codigo" required="" autofocus="true" style ="height:30px;font-size:20px;">
                        ...
                        <div class="col-lg-6" style ='margin-bottom:2%;'>
								<button id ="btn_Validar"class="btn btn-md btn-info col-lg-offset-1 col-lg-3" type="button" style =""> <span class="">Validar</span></button>
						</div>
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="js/sistema/entradaMercaderia.js"></script>              
        <!-- END PLUGINS -->
